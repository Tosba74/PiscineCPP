...
/*   Updated: 2022/01/12 19:12:27 by bmangin          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
	...
	std::cout << this->type << " " << this->_name << " Constructed Default" << std::endl;
	return ;
}
ClapTrap::ClapTrap(std::string name) : _name(name)
{
	...
	this->setEnergy(maxEnergy);
	this->setAttack(maxAttack);
	std::cout << this->type << " " << this->_name << " Constructed" << std::endl;
	return ;
}
ClapTrap::ClapTrap(ClapTrap const& cpy)
{
	*this = cpy;
	std::cout << this->type << this->_name << " Copy Constructed" << std::endl;
	return ;
}
ClapTrap::~ClapTrap()
{
	std::cout << "Destructor kill " << this->_name << ", He is dead !"<< std::endl;
...
void			ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << "Now :" << this->_hitPoints << "HP";
	if (!getHitPoints())
		std::cout << " Oh no, " << this->type << " " << this->_name << " is dead !";
	std::cout << std::endl;
	return ;
}
...
{
	if (!getHitPoints())
		std::cout << "ClapTrap " << this->_name << " can't heal! He is dead :'(" << std::endl;
	else if (getHitPoints() > 0)
	{
		...
		std::cout << "ClapTrap " << this->_name << " take " << amount << " points of heal!" << std::endl;
		std::cout << "Now :" << this->_hitPoints << "HP" << std::endl;
	}
	return ;
}
